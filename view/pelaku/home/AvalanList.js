      ...
      return (
        <View style={styles.styledContainer}>
          <TouchableOpacity style={styles.buttonTambahItem} onPress={() => {
            navigation.navigate("TambahAvalan");
          }}>
            <Text style={styles.buttonTambahItemText}><Ionicons name="add" size={20} color="white" />Tambah Avalan</Text>
          </TouchableOpacity>
          <ScrollView>
            <View style={styles.cardContainer}>
              {
                listData.length > 0 ? listData.map((item) =>
                  ...
                  <View style={styles.styledContainerMulaiCSO}>
                    <Text style={{ fontWeight: 'bold', fontSize: 16, textAlign: 'center' }}>
                      Belum ada avalan CSO, silahkan tambah item terlebih dahulu
                    </Text>
                  </View>
              }
            </View>
